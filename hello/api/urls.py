...
urlpatterns = [
	...
	# path('user/registrationv2/', CustomUserCreateView.as_view(), name="profile-create"),
	...
	# API ENDPOINT for creating events and editing events
	path('event/', EventCreateView.as_view(), name="event-create"),
	path('event/<int:pk>/', EventRudView.as_view(), name="event-crud"),
	# Users can register for the event and edit their registrations
	path('event/<int:pk>/register', ProfileCreateView.as_view(), name="registration-create"),
	# path('event/<int:pk>/registration/<int:pk>', RegistrationRudView.as_view(), name="registration-crud"),
	...
	# path('register/', ProfileCreateView.as_view(), name="registration-create"),
